...
| Current phase | v0.4.7 plugin with DESIGN.md governance, clean reinstall management, project hygiene self-inspection fix, clean initialization, plugin upgrade migration, routing, quality gates, and self-tests | `.codex-plugin/plugin.json`, `README.zh-CN.md`, `tests/selftest.py` | confirmed |
...
| 2026-04-23 | The project ships 28 bundled skills in `skills/`. | v0.4.7 release workflow | confirmed | `README.md`, `tests/selftest.py`, `skills/design-md-governor/SKILL.md` |
...
- Date: 2026-04-23
- Reviewer: Codex v0.4.7 DESIGN.md Governor workflow
