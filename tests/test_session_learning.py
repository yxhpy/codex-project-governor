        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            payload = {
                ...
                "items": [
                    ...
                    {
                        "type": "stale_memory",
                        "memory": "Old release says latest is v6.0.3",
                        "path": "docs/memory/PROJECT_MEMORY.md",
                        "reason": "v6.0.4 superseded it",
                    },
                    {
                        "type": "command_failure",
                        "command": "curl -H 'Authorization: token ghp_secretsecretsecretsecret' https://example.invalid",
                        "error": "401",
                    },
                ],
            }
